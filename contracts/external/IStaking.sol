...
interface IStaking {
    ...
    function unlockAndRemoveManager(address _user, address _lockManager)
        external;

    function increaseLockAllowance(address _lockManager, uint256 _allowance)
        external;
    ...
    function getLock(address _user, address _lockManager)
        external
        view
        returns (uint256 _amount, uint256 _allowance);
    ...
    function getBalancesOf(address _user)
        external
        view
